...
//        stubRequestEvent.getHeaders() >> ["Content-Type": "multipart/form-data"]
...
//""".bytes.encodeBase64()
//
//        final String efsMountPath = Constants.EfsMountPath;
////        Constants.EfsMountPath = FileUtils.TestDirectoryPath;
//
//        when:
//        new ApiRequestHandler().parseRequestEvent(stubRequestEvent)
//
//        then:
//        new File("${Constants.EfsMountPath}/${FileUtils.InputPathPart}/test.csv").exists()
//
//        cleanup:
//        new File("${Constants.EfsMountPath}/${FileUtils.InputPathPart}/test.csv").delete()
////        Constants.EfsMountPath = efsMountPath;
    }
